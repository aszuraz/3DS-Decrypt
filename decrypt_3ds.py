                        ...
                        if magic == b"NCCH":
                                    ...
                                    for j in range(10):
                                        ...
                                        if fname == b".code":
                                            ...
                                            for i in range(datalenM):
                                                ...
                                                print("\rPartition %1d ExeFS: Decrypting: .code... %4d / %4d mb..." % (p, i, datalenM + 1), end='')
                                            if datalenB > 0:
                                                g.write(exefsctrmode2C.encrypt(exefsctrmode.decrypt(f.read(datalenB))))
                                            print("\rPartition %1d ExeFS: Decrypting: .code... %4d / %4d mb... Done!" % (p, datalenM + 1, datalenM + 1))
                            ...
                            if romfs_off[0] != 0:
                                ...
                                for i in range(romfsSizeM):
                                    ...
                                    print("\rPartition %1d RomFS: Decrypting: %4d / %4d mb" % (p, i * romfsBlockSize, romfsSizeTotalMb), end='')
                                if romfsSizeB > 0:
